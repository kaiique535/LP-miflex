...
const slides = [
  {
    id: 1,
    title: "Sua Coleção no Balde!",
    subtitle: "Descubra o balde Mi-Flex cheio de miniaturas flexíveis prontas para a diversão.",
  ...
  {
    id: 2,
    title: "Pinte e Dê Vida!",
    subtitle: "Use canetinhas para criar suas próprias cores em nossos modelos exclusivos em branco.",
  ...
  {
    id: 3,
    title: "Muitos Personagens!",
    subtitle: "Raposas, Axolotes, Unicórnios e muito mais. Colecione todos os amigos Mi-Flex.",
